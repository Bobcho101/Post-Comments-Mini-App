 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cl=pl;function Gs(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const i=Object.assign({name:An,automaticDataCollectionEnabled:!1},e),s=i.name;if(typeof s!="string"||!s)throw ie.create("bad-app-name",{appName:String(s)});if(t||(t=Ls()),!t)throw ie.create("no-options");const r=Rt.get(s);if(r){if(bn(t,r.options)&&bn(i,r.config))return r;throw ie.create("duplicate-app",{appName:s})}const o=new Ia(s);for(const l of Nn.values())o.addComponent(l);const a=new yl(t,i,o);return Rt.set(s,a),a}function El(n=An){const e=Rt.get(n);if(!e&&n===An&&Ls())return Gs();if(!e)throw ie.create("no-app",{appName:n});return e}function Ie(n,e,t){var i;let s=(i=_l[n])!==null&&i!==void 0?i:n;t&&(s+=`-${t}`);const r=s.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${s}" with version "${e}":`];r&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),X.warn(a.join(" "));return}xt(new tt(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ml{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return Z(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jl{constructor(){this.counters_={}}incrementCounter(e,t=1){Z(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return ea(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Pn;function Dc(n){Pn=n}const br=function(n){return typeof n=="number"?"number:"+Js(n):"string:"+n},Ir=function(n){if(n.isLeafNode()){const e=n.val();f(typeof e=="string"||typeof e=="number"||typeof e=="object"&&Z(e,".sv"),"Priority must be a string or number.")}else f(n===Pn||n.isEmpty(),"priority of unexpected type.");f(n===Pn||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kt(n,e){return{eventCache:n,serverCache:e}}function je(n,e,t,i){return Kt(new ae(e,t,i),n.serverCache)}function xr(n,e,t,i){return Kt(n.eventCache,new ae(e,t,i))}function Ft(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function ye(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gh{getCompleteChild(e){return null}getChildAfterChild(e,t,i){return null}}const Lr=new gh;class ri{constructor(e,t,i=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=i}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new ae(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return si(this.writes_,e,i)}}getChildAfterChild(e,t,i){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:ye(this.viewCache_),r=_h(this.writes_,s,t,1,i,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ht;class Br{constructor(){this.views=new Map}}function Dh(n){f(!Ht,"__referenceConstructor has already been defined"),Ht=n}function kh(){return f(Ht,"Reference.ts has not been loaded"),Ht}function Oh(n){return n.views.size===0}function oi(n,e,t,i){const s=e.source.queryId;if(s!==null){const r=n.views.get(s);return f(r!=null,"SyncTree gave us an op for an invalid query."),ps(r,e,t,i)}else{let r=[];for(const o of n.views.values())r=r.concat(ps(o,e,t,i));return r}}function Ur(n,e,t,i,s){const r=e._queryIdentifier,o=n.views.get(r);if(!o){let a=$t(t,s?i:null),l=!1;a?l=!0:i instanceof m?(a=ii(t,i),l=!1):(a=m.EMPTY_NODE,l=!1);const c=Kt(new ae(a,l,!1),new ae(i,s,!1));return new Th(e,c)}return o}function Mh(n,e,t,i,s,r){const o=Ur(n,e,i,s,r);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,o),xh(o,t),Ph(o,t)}function Lh(n,e,t,i){const s=e._queryIdentifier,r=[];let o=[];const a=le(n);if(s==="default")for(const[l,c]of n.views.entries())o=o.concat(fs(c,t,i)),ds(c)&&(n.views.delete(l),c.query._queryParams.loadsAllData()||r.push(c.query));else{const l=n.views.get(s);l&&(o=o.concat(fs(l,t,i)),ds(l)&&(n.views.delete(s),l.query._queryParams.loadsAllData()||r.push(l.query)))}return a&&!le(n)&&r.push(new(kh())(e._repo,e._path)),{removed:r,events:o}}function Hr(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function re(n,e){let t=null;for(const i of n.views.values())t=t||Rh(i,e);return t}function Wr(n,e){if(e._queryParams.loadsAllData())return Xt(n);{const i=e._queryIdentifier;return n.views.get(i)}}function Vr(n,e){return Wr(n,e)!=null}function le(n){return Xt(n)!=null}function Xt(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ci{constructor(e,t,i,s){this._repo=e,this._path=t,this._queryParams=i,this._orderByCalled=s}get key(){return v(this._path)?null:gr(this._path)}get ref(){return new ee(this._repo,this._path)}get _queryIdentifier(){const e=ss(this._queryParams),t=jn(e);return t==="{}"?"default":t}get _queryObject(){return ss(this._queryParams)}isEqual(e){if(e=Ce(e),!(e instanceof Ci))return!1;const t=this._repo===e._repo,i=Cr(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return t&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+wc(this._path)}}class ee extends Ci{constructor(e,t){super(e,t,new ei,!1)}get parent(){const e=yr(this._path);return e===null?null:new ee(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class ht{constructor(e,t,i){this._node=e,this.ref=t,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new w(e),i=ut(this.ref,e);return new ht(this._node.getChild(t),i,T)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new ht(s,ut(this.ref,i),T)))}hasChild(e){const t=new w(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function sn(n,e){return n=Ce(n),n._checkNotDeleted("ref"),e!==void 0?ut(n._root,e):n._root}function ut(n,e){return n=Ce(n),y(n._path)===null?ou("child","path",e):io("child","path",e),new ee(n._repo,R(n._path,e))}function po(n,e){n=Ce(n),so("push",n._path),no("push",e,n._path,!0);const t=oo(n._repo),i=Tu(t),s=ut(n,i),r=ut(n,i);let o;return o=Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}function _o(n,e){n=Ce(n),so("set",n._path),no("set",e,n._path,!1);const t=new zt;return gu(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function mo(n){n=Ce(n);const e=new Ru(()=>{}),t=new Ei(e);return mu(n._repo,n,t).then(i=>new ht(i,new ee(n._repo,n._path),n._queryParams.getIndex()))}class Ei{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const i=t._queryParams.getIndex();return new Au("value",this,new ht(e.snapshotNode,new ee(t._repo,t._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Nu(this,e,t):null}matches(e){return e instanceof Ei?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}Dh(ee);Fh(ee);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
